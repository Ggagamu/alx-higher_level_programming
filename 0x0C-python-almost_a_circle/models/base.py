...
class Base:
    ...
    Acts as the "base" for all other classes.
    """
    ...
    def to_json_string(list_dictionaries):
        """Return JSON string representation of  dictionaries list"""
    ...
    def save_to_file_csv(cls, list_objs):
        """Save list_objs to a file after serialization."""
